...
public class Lambda_01_Test {
    ...
    public void test_filter_by_age() throws Exception {
        ...
        // TODO result ne doit contenir que des personnes adultes (age >= 18)
         PersonPredicate personPredicate1 = (p) -> ( p.getAge() >= 18)  ;
        
        List<Person> result = filter(personList, personPredicate1);
    ...
    public void test_filter_by_firstname() throws Exception {
     ...
     // TODO result ne doit contenir que des personnes dont le prénom est "first_10"
        PersonPredicate personPredicate2 =(p)-> ( p.getFirstname().equals("first_10"));
		 

        
        List<Person> result = filter(personList, personPredicate2);
    ...
    public void test_filter_by_password() throws Exception {
        ...
        PersonPredicate pers3 = (Person p) -> (p.getAge() > 49 && passwordSha512Hex.equals(DigestUtils.sha512Hex(p.getPassword()))) ;
        ...
        List<Person> result = filter(personList, pers3);
